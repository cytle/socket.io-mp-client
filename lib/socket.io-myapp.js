...
var hasBin = __webpack_require__(7);
...
exports.Socket = __webpack_require__(13);
...
WS.prototype.doOpen = function () {
  ...
  try {
    this.ws = protocols ? new WebSocket(uri, protocols) : new WebSocket(uri);
  } catch (err) {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(32)(module), __webpack_require__(1)))
...
var _connectSocket = __webpack_require__(39);
...
var _connectSingleSocket = __webpack_require__(40);
...
function connectSocket(instance) {
  if ((0, _connectSingleSocket.hasSingleSocket)()) {
    return (0, _connectSingleSocket2.default)(instance);
  }
  var socketTask = my.connectSocket(instance.$options);
  if (socketTask) {
...
var _socketGlobalEventHandle = __webpack_require__(41);
...
function popGlobal() {
  ...
  my.connectSocket(nextGlobalWebsocket.$options);
...
exports.default = socketGlobalEventHandle;
 ...
 */
function socketGlobalEventHandle() {
  ...
  if (my.offSocketOpen) {
    ...
    Object.keys(listeners).forEach(function (key) {
      my['off' + key](listeners[key]);
      my['on' + key](listeners[key]);
    });
  } else {
    needListen = false;
    Object.keys(listeners).forEach(function (key) {
